...
from layers.Crossformer_EncDec import scale_block6, Encoder, Decoder, DecoderLayer
from layers.Embed import PatchEmbedding
from layers.SelfAttention_Family import AttentionLayer, FullAttention, TwoStageAttentionLayer5,TwoStageAttentionLayer2random
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.encoder = Encoder(
            [
                scale_block6(configs, 1 if l is 0 else self.win_size, configs.d_model, configs.n_heads, configs.d_ff,
                            1, configs.dropout,
        ...
        self.decoder = Decoder(
            [
                DecoderLayer(
                    TwoStageAttentionLayer5(configs, (self.pad_out_len // self.seg_len), configs.factor, configs.d_model, configs.n_heads,
